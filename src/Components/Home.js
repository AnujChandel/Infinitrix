...
export default function Home(){
    return(
        <div className="container">
            ...
            <p>An in-depth look at each of the main windows you’ll use every day in Unity, including useful shortcuts and hotkeys.
...
Important notes for upgrading projects that were authored with older versions of Unity.</p>
            
<p>Use this page to discover and learn production-tested best practices from Unity experts. <p>The Technical Content Marketing team at Unity created the guides listed on this page together with industry experts.</p> engineers and technical artists from Unity R&D and the Accelerate Games Solutions teams.</p>
        
        
        <p>Use this guide to learn how to set up a new project with URP or convert an existing Built-in Render Pipeline-based project to URP. Learn about URP quality settings and shaders
, setting up lighting, shadows, special effects, and more.</p>
<p>This guide provides in-depth reference for creating high-end lighting for PC and console games and covers topics such as HDRP settings, cameras
, and Volume frameworks, creating skyscapes, reflections, real-time lighting, and more.</p>
        <p>
